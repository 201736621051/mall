...
import priv.jesse.mall.utils.SendmailUtil2;
...
public class OrderServiceImpl implements OrderService {
    ...
    public void updateStatus(int id, int status) throws Exception {
        ...
        User user = userDao.findOne(one.getUserId());
//        MailUtils.sendMail(user.getEmail(),"你好,你的商品已发货。","商城");
        SendmailUtil2.sendMall(user.getEmail());
    }
